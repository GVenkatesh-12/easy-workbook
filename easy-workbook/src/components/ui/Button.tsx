...
const sizeClasses: Record<Size, string> = {
  sm: 'px-3 py-1.5 text-[11px] gap-1.5 rounded-lg min-h-[32px]',
  md: 'px-4 py-2 text-xs gap-2 rounded-lg min-h-[36px]',
  lg: 'px-5 py-2.5 text-sm gap-2 rounded-lg min-h-[40px]',
};
